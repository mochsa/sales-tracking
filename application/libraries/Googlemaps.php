...
class Googlemaps
{
	...
	var $apiKey						= 'AIzaSyD5Hq9uCL01sUTYy2DQBZgoHrpdLQBipqA'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
