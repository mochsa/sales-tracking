...
class Googlemaps
{
	...
	var $apiKey						= 'AIzaSyAdKDUrJZhDjy7U8eoNVITPVUwCpNGf4sY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
